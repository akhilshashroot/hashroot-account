...
class HashrootBillAddEdit extends React.Component {
    ...
    componentDidMount = () => {
        this.setState({
            invoiceNum: this.props?.hashrootinvoice?.hashrootinvoice?.invo_number_add,
        });
    ...
    componentDidUpdate(prevProps, prevState) {
        if (this.props.hashrootbill && this.props.hashrootbill.HashrootbillAdd) {
            if (prevProps.hashrootbill.HashrootbillAdd !== this.props.hashrootbill.HashrootbillAdd) {
                this.props.getHashrootBillList();

                this.toggleModal();
            }
        }
        if (this.props.hashrootbill && this.props.hashrootbill.HashrootbillUpdate) {
            if (prevProps.hashrootbill.HashrootbillUpdate !== this.props.hashrootbill.HashrootbillUpdate) {
                this.props.getHashrootBillList();
    ...
    addHashrootBill() {
        if (
            ...
            fd.append('bill_table_name', 'hashroot_bills');
            ...
            // let data = {
            //     bill_table_name: 'hashroot_bills',
                    ...
                    <CardBody>
                        <Modal
                            ...
                            <ModalHeader toggle={this.toggleModal} className="modal-colored-header bg-dark">
                                {data !== null ? 'Edit Hashroot Bill' : 'Add New Hashroot Bill'}
                            </ModalHeader>
                            <ModalBody>
