...
class HashrootInvoiceAddEdit extends React.Component {
    ...
    componentDidMount = () => {
        this.setState({
            invoiceNum: this.props?.hashrootinvoice?.hashrootsinvoice?.invo_number_add,
        });
    ...
    componentDidUpdate(prevProps, prevState) {
        if (this.props.hashrootinvoice && this.props.hashrootinvoice.hashrootsinvoiceAdd) {
            if (prevProps.hashrootinvoice.hashrootsinvoiceAdd !== this.props.hashrootinvoice.hashrootsinvoiceAdd) {
                this.props.getHashrootsInvoiceList();

                this.toggleModal();
            }
        }
        if (this.props.hashrootinvoice && this.props.hashrootinvoice.hashrootsinvoiceUpdate) {
            if (
                prevProps.hashrootinvoice.hashrootsinvoiceUpdate !== this.props.hashrootinvoice.hashrootsinvoiceUpdate
            ) {
                this.props.getHashrootsInvoiceList();
