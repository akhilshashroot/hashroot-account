...
class HashrootInvoiceDelete extends React.Component {
    ...
    componentDidUpdate(prevProps, prevState){
        if(this.props.hashrootinvoice && this.props.hashrootinvoice.hashrootsinvoiceDelete ){
            if(prevProps.hashrootinvoice.hashrootsinvoiceDelete !== this.props.hashrootinvoice.hashrootsinvoiceDelete){
