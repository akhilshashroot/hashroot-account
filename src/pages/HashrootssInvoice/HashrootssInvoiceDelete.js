...
class HashrootInvoiceDelete extends React.Component {
    ...
    componentDidUpdate(prevProps, prevState){
        if(this.props.hashrootinvoice && this.props.hashrootinvoice.hashrootssinvoiceDelete ){
            if(prevProps.hashrootinvoice.hashrootssinvoiceDelete !== this.props.hashrootinvoice.hashrootssinvoiceDelete){
