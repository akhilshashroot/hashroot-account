...
import {
    getHashrootpBillList,
    getHashrootpBillAdd,
    getHashrootpBillUpdate,
    getHashrootpBillDelete,
    getHashrootpCloneBill,
    downloadBill,
} from '../../redux/actions';
...
const HashrootBillConfig = (props) => {
    ...
    const invoiceClone = (row, index) => {
        ...
        props.getHashrootpCloneBill(data);
    };
                    ...
                    <React.Fragment>
                        <Row>
                            <Col className="text-right mb-1">
                                <Button color="danger" className="mb-2" onClick={() => handleAddEditModal()}>
                                    <i className="mdi mdi-plus-circle mr-2"></i> Add New Hashroot-P Bill
                                </Button>
                            </Col>
                        </Row>
                        ...
                        {toggleAddEditModal && (
                            <HashrootBillAddEdit
                                ...
                                getHashrootBillAdd={props.getHashrootpBillAdd}
                                getHashrootBillUpdate={props.getHashrootpBillUpdate}
                                hashrootbill={props.hashrootbill}
                                getHashrootpBillList={props.getHashrootpBillList}
                            />
                        )}
                        ...
                        {toggleDeleteModal && (
                            <HashrootBillDelete
                                ...
                                getHashrootBillDelete={props.getHashrootpBillDelete}
                                data={hashrootbillData}
                                records={
                                    props.hashrootbill &&
                                    props.hashrootbill.hashrootbill &&
