...
class HashrootInvoiceDelete extends React.Component {
    ...
    componentDidUpdate(prevProps, prevState){
        if(this.props.hashrootinvoice && this.props.hashrootinvoice.hashrootpinvoiceDelete ){
            if(prevProps.hashrootinvoice.hashrootpinvoiceDelete !== this.props.hashrootinvoice.hashrootpinvoiceDelete){
