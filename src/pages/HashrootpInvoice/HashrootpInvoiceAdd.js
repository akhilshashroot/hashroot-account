...
class HashrootInvoiceAddEdit extends React.Component {
    ...
    componentDidUpdate(prevProps, prevState) {
        if (this.props.hashrootinvoice && this.props.hashrootinvoice.hashrootpinvoiceAdd) {
            if (prevProps.hashrootinvoice.hashrootpinvoiceAdd !== this.props.hashrootinvoice.hashrootpinvoiceAdd) {
                this.props.getHashrootpInvoiceList();

                this.toggleModal();
            }
        }
        if (this.props.hashrootinvoice && this.props.hashrootinvoice.hashrootpinvoiceUpdate) {
            if (
                prevProps.hashrootinvoice.hashrootpinvoiceUpdate !== this.props.hashrootinvoice.hashrootpinvoiceUpdate
            ) {
                this.props.getHashrootpInvoiceList();
                                    ...
                                    <Row>
                                        ...
                                        <Col md={6}>
                                            <FormGroup className='pl-5'>
                                                    <Label for="exampleDate" className='pr-5'>Invoice Date</Label>
                                                    <DatePicker
                                        ...
                                        <Col md={6}>
                                            <FormGroup className='pl-5'>
                                                    <Label for="exampleDate" className='pr-5'>Due Date</Label>
                                                    {/* <Input
                                                    type="date"
                                                    name="date"
                                                    id="exampleDate"
