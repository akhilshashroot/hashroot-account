...
const HashrootsInvoice = React.lazy(() => import('../pages/HashrootsInvoice/index'));
const HashrootssInvoice = React.lazy(() => import('../pages/HashrootssInvoice/index'));
const HashrootInvoice = React.lazy(() => import('../pages/HashrootInvoice/index'));

//Hashroot Bills
const HashrootpBill = React.lazy(() => import('../pages/HashrootpBill/index'));
const HashrootsBill = React.lazy(() => import('../pages/HashrootsBill/index'));
const HashrootssBill = React.lazy(() => import('../pages/HashrootssBill/index'));
const HashrootBill = React.lazy(() => import('../pages/HashrootBills/index'));
...
// All routes
const allRoutes = [rootRoute,...appRoutes, authRoutes, myProfileRoutes];
